...
- **Laravel Architect** , **Laravel Backend** , **Laravel API** , **Ionic Framework** , **Angular** , **Capacitor** , **Cordova**, **WordPress API Extension** , **WooCommerce API Extension and Override** , **QR Code Base Authentication and Ticket Checkin System** , **RFID Based Cashless Wallet**
